...
def populate_demo_data(
    ...
    for _ in range(30):
        random_idx: int = randint(0, len(users) - 1)
        checkin_service.checkin(users[random_idx])
